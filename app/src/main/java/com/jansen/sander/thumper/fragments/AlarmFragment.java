...
public class AlarmFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        alarmButton = getView().findViewById(R.id.toggleAlarm);
        alarmButton.setOnClickListener(btnListener);
    }
    ...
    private void toggleAlarm(){
        alarm.setToggleAlarm();

        final Call<Alarm> alarm =  ((MainActivity)getActivity()).getRetrofitService().setAlarm(this.alarm);
        alarm.enqueue(new Callback<Alarm>() {
            @Override
